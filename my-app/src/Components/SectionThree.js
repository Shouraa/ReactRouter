...
class SectionThree extends Component {
    ...
    validate = (portfolio) => {
      const errors = {portfolio: /((([A-Za-z]{3,9}:(?:\/\/)?)(?:[\-;:&=\+\$,\w]+@)?[A-Za-z0-9\.\-]+|(?:www\.|[\-;:&=\+\$,\w]+@)[A-Za-z0-9\.\-]+)((?:\/[\+~%\/\.\w\-_]*)?\??(?:[\-\+=&;%@\.\w_]*)#?(?:[\.\!\/\\\w]*))?)/.test(portfolio)
      ? ''
      : 'FILL THE FIELD'
      };
      return errors;
    ...
    render() {
      ...
      const errors = this.validate(portfolio)
        return(
            ...
            <h5>Prove you're IBM's next great designer by showing us who you are. What you've done. How you think. Thell us your story.</h5>
            ...
            <div className="flex-box">
              ...
              <div className="flex-100">
                <textarea name="more_info" rows="5" placeholder="Anything else (another link, availability, etc)?"></textarea>
              </div>
