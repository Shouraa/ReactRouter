				...
				<div className="flex-box">
					<div className="flex-25">
						<input
							...
							value="dr"
							name="rad_btn"
							checked={this.state.radiobtns === 'dr'}
					...
					<div className="flex-25">
						<input
							...
							value="vd"
							name="rad_btn"
							checked={this.state.radiobtns === 'vd'}
							onChange={this.handleRadioBtn}
							id="vd"
						/>
						<label className="label" htmlFor="vd">
							Visual Design
						</label>
					</div>
					...
					<div className="flex-25">
						<input
							...
							value="ud"
							name="rad_btn"
							checked={this.state.radiobtns === 'ud'}
							onChange={this.handleRadioBtn}
							id="ud"
						/>
						<label className="label" htmlFor="ud">
							{' '}
							UX Design
						</label>
					</div>
					...
					<div className="flex-25">
						<input
							...
							value="fd"
							name="rad_btn"
							checked={this.state.radiobtns === 'fd'}
							onChange={this.handleRadioBtn}
							id="fd"
						/>
						<label className="label" htmlFor="fd">
							Front-end Dev
						</label>
					</div>
				</div>
				...
				<div id="wrap">
					<div className="left">
						<div className="left_chcbox">
							<h5>
								Do you have experience with any other <br /> disciplines?
							</h5>

							<label htmlFor="Visual_d" className="checkbox">
								Visual Design
								<input
									type="checkbox"
									id="Visual_d"
							...
							<label htmlFor="ux_d" className="checkbox">
								UX-Design
								<input
									type="checkbox"
									id="ux_d"
									...
									value="ux_d"
								/>
								<span htmlFor="ux_d" className="checkmark" />
							</label>

							<label htmlFor="fe_d" className="checkbox">
							...
							{left_chckboxes.length === 0 ? (
								<span className="err-msg">{errors.left_chckboxes}</span>
							) : (
								<span />
							)}
						</div>
					...
					<div className="right">
						<div className="right_chcbox">
							...
							<p>
								{' '}
								You must be legally authorized to work without visa <br />{' '}
								sponsorship in the location(s) you choose.{' '}
							</p>

							<label htmlFor="aus" className="checkbox">
								Austin, Texas
								<input
									type="checkbox"
									id="aus"
							...
							<label htmlFor="ny" className="checkbox">
								New York, New York
								<input
									type="checkbox"
									id="ny"
							...
							<label htmlFor="toronto" className="checkbox">
								Toronto, Canada
								<input
									type="checkbox"
									id="toronto"
							...
							<label htmlFor="shanghai" className="checkbox">
								Shanghai, China
								<input
									type="checkbox"
									id="shanghai"
							...
							<label htmlFor="dublin" className="checkbox">
								Dublin, Ireland
								<input
									type="checkbox"
									id="dublin"
							...
							<label htmlFor="hursley" className="checkbox">
							...
							<label htmlFor="boeblingen" className="checkbox">
								Boeblingen, Germany
								<input
									type="checkbox"
									id="boeblingen"
							...
							<label htmlFor="else" className="checkbox">
								Somwhere else
								<input
									type="checkbox"
									id="else"
							...
							{right_chckboxes.length === 0 ? (
								<span className="err-msg">{errors.right_chckboxes}</span>
							) : (
								<span />
							)}
						</div>
