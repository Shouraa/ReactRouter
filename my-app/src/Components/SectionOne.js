...
class SectionOne extends Component {
  ...
  validate = (fullName, phone, email, reemail, address, city, state, region, zip, how) => {
    const errors = {
      fullName: /^[a-zA-Z\\s]+/.test(fullName) ? '' : 'you can have only alphabetic characters',
      ...
      reemail: /^(([^<>()[\]\\.,;:\s@"]+(\.[^<>()[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/.test(
        ...
        ? ''
        : 'enter a valid email',
      address: /^[a-zA-Z]+(?:[\s-][a-zA-Z]+)*$/.test(address) ? '' : 'address not valid',
      city: /^[a-zA-Z]+(?:[\s-][a-zA-Z]+)*$/.test(city) ? '' : 'enter the city',
      state: /^[a-z][ a-z|A-Z]{1,49}$/.test(state) ? '' : 'enter the state',
      region: /^[a-z][ a-z|A-Z]{1,49}$/.test(region) ? '' : 'enter the region',
      zip: /^[0-9]{5}$/.test(zip) ? '' : 'enter the zip',
      how: /^[a-z][ a-z|A-Z|0-9]{1,99}$/.test(how) ? '' : 'please fill',
    };
    return errors;
  };
        ...
        <div className="flex-box">
          ...
          <div className="flex-25">
            <input
              ...
              value={phone}
            />
            {isTouched.phone && errors.phone && <span className="err-msg">{errors.phone}</span>}
          </div>
          ...
          <div className="flex-75">
            <input
              ...
              value={email}
            />
            {isTouched.email && errors.email && <span className="err-msg">{errors.email}</span>}
          </div>
          ...
          <div className="flex-25">
            <input
              ...
              value={city}
            />
            {isTouched.city && errors.city && <span className="err-msg">{errors.city}</span>}
          </div>
          ...
          <div className="flex-25">
            <input
              ...
              value={state}
            />
            {isTouched.state && errors.state && <span className="err-msg">{errors.state}</span>}
          </div>
          ...
          <div className="flex-25">
            <input
              ...
              value={region}
            />
            {isTouched.region && errors.region && <span className="err-msg">{errors.region}</span>}
          </div>
          ...
          <div className="flex-25">
            <input
              ...
              value={zip}
            />
            {isTouched.zip && errors.zip && <span className="err-msg">{errors.zip}</span>}
          </div>
          ...
          <div className="flex-100">
            <input
              ...
              value={how}
            />
            {isTouched.how && errors.how && <span className="err-msg">{errors.how}</span>}
          </div>
